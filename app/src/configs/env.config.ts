...
const TEE_ENDPOINT =
  process.env.NEXT_PUBLIC_TEE_ENDPOINT ||
...
const BRIDGE_PROGRAM_ID =
  process.env.NEXT_PUBLIC_BRIDGE_PROGRAM_ID || '5KZn4QgDQs8MaPEt8D852cpog3h7C9E2TbsrqWb4dWfU';
const LZ_ENDPOINT_PROGRAM_ID = '76y77prsiCMvXMjuoZ5VRrhG5qYBrUMYTE5WgHqgjEn6';
