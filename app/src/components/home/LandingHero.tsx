...
export default function LandingHero() {
    return (
        <section className="relative w-full min-h-screen bg-black overflow-hidden pt-5">
            <div className="relative z-10 container mx-auto px-4 md:px-6 h-full flex flex-row justify-between items-center pt-5">
                <motion.div 
                ...
                <p className="font-rajdhani font-medium text-lg md:text-xl text-[#999999] max-w-2xl mb-8 leading-relaxed">
                ...
                <div className="h-[460px] opacity-60 md:opacity-100 pointer-events-none">
                    <img 
                        src="/hero.png" 
