...
const buyingSteps = [
  {
    ...
    description: 'Using NEAR Intents, the system automatically swaps your deposit to Zcash based on ticket amount. Support for ETH, USDC, NEAR, and more.',
    icon: '/assets/cb1421c4-3bf2-44a8-8363-ceee76d28079.svg'
  },
  {
    id: '2',
    title: 'ZK-SNARK proof generation',
    description: 'Generates a zero-knowledge proof that acts as an IOU of predetermined amount at the mint price. This proof is your claim ticket.',
    icon: '/assets/6fabe7f7-c928-4884-a5b8-a60532de12e4.svg'
  },
  {
    id: '3',
    title: 'Capital allocation',
    description: 'Allocated capital is deposited into the Meteora pool, providing liquidity for the token launch while maintaining your privacy.',
    icon: '/assets/ef04d249-60f9-420b-a338-4bb3b55ba25b.svg'
  },
  {
    id: '4',
    title: 'Flexible claiming',
    description: 'With the claim system via proofs, you can either claim on Solana or bridge via omni token to claim on your desired Layer Zero OFT supported chain.',
...
const createSteps = [
    {
      id: '1',
      title: 'Set pricing',
      description: 'Outline price and number of tokens per Zcash. Define your token economics and allocation strategy.',
      icon: '/assets/c56d449b-85dc-4a6e-b752-986216abe427.svg'
    },
    {
      id: '2',
      title: 'Multi-chain configuration',
      description: 'Choose whether to enable Layer Zero for multichain claims and select which supported chains your token can be claimed on.',
      icon: '/assets/28895815-5e2e-4b0f-a704-fc1d60f7e926.svg'
    },
    {
      id: '3',
      title: 'Timeline setup',
      description: 'Define how long the token sale runs, when it starts, and when the claim period begins. Set specific dates and durations.',
      icon: '/assets/65fabe36-7e6d-4c49-b857-4430fb9e11d1.svg'
    },
    {
      id: '4',
      title: 'Minimum requirements',
      description: 'Set minimum thresholds for successful token launch and claim eligibility. Protect both you and your investors.',
