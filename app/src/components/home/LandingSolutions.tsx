...
const solutions = [
  {
    ...
    description: 'Flexible payment options across multiple blockchains and assets. Contribute using ETH, USDC, NEAR, or other supported tokens from any chain.',
    icon: 'https://www.figma.com/api/mcp/asset/0e017655-60f4-4272-b8e2-ba83120c6e70'
  },
  {
    id: '02',
    title: 'The Shielded Settlement',
    description: "All transactions protected by Zcash's privacy-preserving technology. Your contributions are completely shielded from public blockchain surveillance.",
    icon: 'https://www.figma.com/api/mcp/asset/35ac0030-f49f-4243-ad24-0d8eca7b018d'
  },
  {
    id: '03',
    title: 'Claim via ZK Proof Tickets',
    description: 'Claim tokens on Solana using zero-knowledge proof tickets. No on-chain link between your funding source and claim destination.',
...
export default function LandingSolutions() {
  return (
    <section className="bg-[#D0870026] py-16 md:py-24 relative overflow-hidden">
        {/* Background Texture/Image */}
        <div className="absolute top-20 right-20 w-[200px] h-[200px] opacity-10 pointer-events-none">
             <img 
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {solutions.map((solution, index) => (
            <motion.div
              ...
              className="group relative h-[240px] border border-white/10 bg-black/50 backdrop-blur-sm p-6 flex flex-col justify-between"
            >
              {/* Corner Accents */}
              ...
              <div className="flex justify-between items-start w-full">
                <span className="font-rajdhani font-medium text-lg text-[#d08700]">
                    {solution.id}
                </span>
              ...
              <div>
                <h3 className="font-rajdhani font-bold text-xl text-[#feeae6] mb-2">
                    {solution.title}
                </h3>
                <p className="font-rajdhani font-normal text-sm text-[#feeae6] leading-relaxed">
