...
import type { Transaction } from '@/types/bridge.types';
          ...
          <Table className="border-separate border-spacing-y-0 min-w-[768px]">
            <TableHeader className="bg-gray-50 hover:bg-gray-50 rounded-t-xl">
              <TableRow className="hover:bg-gray-50">
                ...
                <TableHead
                  className="text-xs font-medium text-gray-900 text-right"
            ...
            <TableBody>
              {transactions.length === 0 ? (
                ...
                currentTransactions.map((tx) => <TableTx key={tx.id} transaction={tx} />)
              )}
            </TableBody>
          </Table>
        </div>
