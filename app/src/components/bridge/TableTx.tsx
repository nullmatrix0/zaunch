...
import type { ChainType } from '@/types/bridge.types';
...
export function TableTx({ transaction }: { transaction: Transaction }) {
  ...
  return (
    <TableRow className="hover:bg-gray-50">
      <TableCell className="text-xs sm:text-sm text-gray-600" style={{ paddingLeft: '20px' }}>
      ...
      <TableCell
        className={`text-xs sm:text-sm font-medium ${getStatusColor(transaction.status)} flex items-center gap-1`}
      >
